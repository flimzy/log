...
//
// In particular, it exposes only the log.Print* functions, and adds an additional
// log.Debug* set of functoins, which in turn call their log.Print* counterparts
// only when the 'debug' build tag is present.
package log
